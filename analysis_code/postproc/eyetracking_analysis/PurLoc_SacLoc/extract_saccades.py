...
python extract_saccades.py sub-01 SacLoc
-----------------------------------------------------------------------------------------
"""
# Stop warnings
# -------------
...
file_dir_save = '/Users/sinakling/projects/PredictEye/data' #! REPLACE WITH LOCAL DIRECTORY (same as eyetraces)
...
for run in runs:
	...
	for sequence in sequences:
		...
		for trial in trials:
			...
			#print("duration ", dur_trial)
			time_prct = ((eye_data_runs[data_logic][:,0]- t_trial_start)/dur_trial)
			#print("time perct ", time_prct)
			#print("eye_data time ", eye_data_runs[data_logic][:,0])
			#print("t trial start ", t_trial_start)
