...
-----------------------------------------------------------------------------------------
Goal of the script:
Save figures for all subjects for PurVELoc and SacVELoc tasks: 
- per run 
- per sequence 
- per trial with marked saccades (only for SacVELoc) 
-----------------------------------------------------------------------------------------
Input(s):
...
python behav_analysis/plotly_plots.py sub-01 PurVELoc
-----------------------------------------------------------------------------------------
"""
import numpy as np
import h5py
...
subjects = ['sub-23','sub-25']
#'sub-02', 'sub-03','sub-05', 'sub-07', 'sub-09', 'sub-12','sub-14', 'sub-17','sub-20','sub-21','sub-22', 
task = sys.argv[2]
...
if task == 'SacVELoc': 
    ...
    for subject in subjects: 
        ...
        h5_filename = '{file_dir}/{sub}_ses-02_task-{task}_eyedata.h5'.format(file_dir = file_dir_save, sub = subject, task = task)
...
subjects = ['sub-02','sub-03','sub-05', 'sub-07', 'sub-09', 'sub-12', 'sub-13','sub-14', 'sub-17', 'sub-20','sub-21', 'sub-22','sub-23','sub-25']
# 
task = 'PurVELoc'
