...
# pRF_session = analysis_info['pRF_session'][0]
# eye_mvt_session = analysis_info['eye_mvt_session'][0]
...
for format_, extension in zip(formats, extensions):
    ...
    for task in tasks : 
        # Contrast
        # if task == 'SacLoc':
        #     func_session = eye_mvt_session
        #     cond1_label, cond2_label = ['Sac'], ['Fix']
        # elif task == 'PurLoc':
        #     func_session = eye_mvt_session
        #     cond1_label, cond2_label = ['Pur'], ['Fix']
        # elif task == 'pRF':
        #     func_session = pRF_session
        #     cond1_label, cond2_label = ['vision'], ['Fix']
