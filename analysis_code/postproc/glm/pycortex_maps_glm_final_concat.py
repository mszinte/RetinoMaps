...
>> python pycortex_maps_glm_final_concat.py [main directory] [project name] [subject num] [save_svg_in]
-----------------------------------------------------------------------------------------
Exemple:
python pycortex_maps_glm_final_concat.py ~/disks/meso_shared RetinoMaps sub-02 n
-----------------------------------------------------------------------------------------
...
for format_, pycortex_subject in zip(formats, [subject, 'sub-170k']):
    ...
    if format_ == 'fsnative': 
        deriv_glm_fn_L = '{}/{}_task-eyes-mvt_hemi-L_space-fsnative_dct_glm-significant_map_concat.func.gii'.format(glm_deriv_dir, subject)
        deriv_glm_fn_R = '{}/{}_task-eyes-mvt_hemi-R_space-fsnative_dct_glm-significant_map_concat.func.gii'.format(glm_deriv_dir, subject)
    ...
    for maps_name in maps_names:
        ...
        exec("plt.savefig('{}/{}_final_{}_concat.pdf')".format(flatmaps_dir, subject, maps_name))
        plt.close()
    ...
    # save dataset
    dataset_file = "{}/{}_final_concat.hdf".format(datasets_dir, subject)
