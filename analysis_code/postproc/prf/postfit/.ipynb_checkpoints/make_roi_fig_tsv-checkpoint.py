...
for format_, extension in zip(formats, extensions):
    ...
    if 'group' not in subject:
        print('subbject {} is processing'.format(subject))
        ...
        for num_roi, roi in enumerate(rois):
            ...
            else: df_ecc_size_bins = pd.concat([df_ecc_size_bins, df_ecc_size_bin])  # TO CHECK IF RESTE INDEX NEEDED
        ...
        for num_roi, roi in enumerate(rois):
            ...
            else: df_ecc_pcm_bins = pd.concat([df_ecc_pcm_bins, df_ecc_pcm_bin])  # TO CHECK IF RESTE INDEX NEEDED
        ...
        for i, hemi in enumerate(hemis):
            ...
            for j, roi in enumerate(rois): #
                ...
                else: df_polar_angle_bins = pd.concat([df_polar_angle_bins, df_polar_angle_bin])  # TO CHECK IF RESTE INDEX NEEDED
        ...
        for j, roi in enumerate(rois):
            ...
            else: df_contralaterality = pd.concat([df_contralaterality, df_contralaterality_roi]) # TO CHECK IF RESTE INDEX NEEDED
