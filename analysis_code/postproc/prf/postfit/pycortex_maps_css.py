...
-----------------------------------------------------------------------------------------
Exemple:
python pycortex_maps_css.py ~/disks/meso_shared RetinoMaps sub-02 y
-----------------------------------------------------------------------------------------
...
prf_dir = "{}/{}/derivatives/pp_data/{}/fsnative/prf".format(main_dir, project_dir, subject)
...
deriv_avg_fn_L = '{}/{}_task-pRF_hemi-L_fmriprep_dct_prf-deriv-loo-avg_css.func.gii'.format(prf_deriv_dir, subject)
deriv_avg_fn_R = '{}/{}_task-pRF_hemi-R_fmriprep_dct_prf-deriv-loo-avg_css.func.gii'.format(prf_deriv_dir, subject)
