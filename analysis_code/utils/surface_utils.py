...
def make_cifti_image(data, source_img):
    ...
    img = nb.Cifti2Image(dataobj=data, header=new_header,extra=extra,file_map=file_map,dtype=dtype)
    
    return img
'''
Example usage:
cor_final_new = np.random.random((170494, 1))
template_file = '/home/skling/disks/meso_shared/RetinoMaps/derivatives/pp_data/sub-02/func/fmriprep_dct/HCP_170k/sub-02_ses-01_task-pRF_run-01_space-fsLR_den-170k_bold_dct.dtseries.nii'
