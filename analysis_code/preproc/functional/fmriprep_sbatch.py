...
-----------------------------------------------------------------------------------------
Exemple:
python fmriprep_sbatch.py /scratch/mszinte/data RetinoMaps sub-25 30 anat_only_n aroma_n fmapfree_n skip_bids_val_n cifti_output_170k_y fsaverage_y 12 uriel.lascombes@etu.univ-amu.fr 327 b327
-----------------------------------------------------------------------------------------
